...
L.Control.GroupedLayers = L.Control.extend({
    ...
    _initLayout: function () {
        ...
        if (L.Browser.mobile) {
            // Add collapse link at top
            var collapseLink = L.DomUtil.create("a", a + '-collapse-link', c);
            collapseLink.innerHTML = "&times;"
            L.DomEvent.on(collapseLink, 'click', this._collapse, this);
        }
