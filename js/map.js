...
function pop_ActiveSensors_1(feature, layer) {
    var popupContent = '<iframe src="' + feature.properties['graph_url'] + '" width="' + popupWidth + '" height="200" frameborder="0"></iframe>' +
        '<br><a href="https://aqdata.uksouth.cloudapp.azure.com:3000/d/lDMgKHfWk/st-denys-detailed-measurements?orgId=1&var-Sensor=' + feature.properties['sensor_id'] + '" target="_blank">Detailed sensor data</a>';
